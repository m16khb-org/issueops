...
- [x] G1: 자기 보고서 생성
  CHECK: test -s .issueops/issues/510/dogfood-report.md
  EVIDENCE: (no output)
- [x] G2: diff 공백 오류 없음
  CHECK: git diff 58b335defd080dc410cb238fc8e229a7d7d37b4e --check
  EVIDENCE: (no output)
- [x] G3: 실제 병렬 claim 관측
...
- [x] G4: 최종 변경 경계
  CHECK: python3 -c "import subprocess; base=\"58b335defd080dc410cb238fc8e229a7d7d37b4e\"; actual=set(subprocess.check_output([\"git\",\"diff\",\"--name-only\",base],text=True).splitlines()).union(set(subprocess.check_output([\"git\",\"ls-files\",\"--others\",\"--exclude-standard\"],text=True).splitlines())); assert actual=={\".issueops/issues/510/dogfood-report.md\",\".issueops/issues/510/gates.md\"},actual; print(\"scope verified\")"
